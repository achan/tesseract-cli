      ...
      def environment(profile, host)
        {
          ...
          "TESSERACT_RUNTIME_APP_NAME" => profile.runtime_app_name.to_s,
          "TESSERACT_S3_BUCKET_NAME_PUBLIC" => profile.public_s3_bucket.to_s,
          "TESSERACT_CDN_BUCKET" => profile.cdn_bucket.to_s,
          "TESSERACT_THEME_GRADIENT_END_COLOR" => profile.runtime_theme.fetch("THEME_GRADIENT_END_COLOR", ""),
          "TESSERACT_THEME_GRADIENT_START_COLOR" => profile.runtime_theme.fetch("THEME_GRADIENT_START_COLOR", ""),
          "TESSERACT_THEME_TOP_BAR_COLOR" => profile.runtime_theme.fetch("THEME_TOP_BAR_COLOR", ""),
